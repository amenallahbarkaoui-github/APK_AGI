...
def test_apply_dart_aot_patch_tools(monkeypatch, tmp_path) -> None:
    ...
    monkeypatch.setattr("apk_agent.agent.tools_def._patch_journal", mock_journal.items)
