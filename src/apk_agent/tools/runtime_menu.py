...
def _generate_panel_drag_listener_smali() -> str:
    return "\n".join([
        ...
        "    return v0",
        "    :apkagi_drag_try_end",
        "    .catch Ljava/lang/Throwable; {:apkagi_drag_try_start .. :apkagi_drag_try_end} :apkagi_drag_catch",
        ":apkagi_drag_catch",
        "    move-exception v0",
        "    const/4 v0, 0x0",
        "    return v0",
...
def _generate_overlay_drag_listener_smali() -> str:
    return "\n".join([
        ...
        "    const/4 v0, 0x0",
        "    return v0",
        "    :apkagi_overlay_drag_try_end",
        "    .catch Ljava/lang/Throwable; {:apkagi_overlay_drag_try_start .. :apkagi_overlay_drag_try_end} :apkagi_overlay_drag_catch",
        ":apkagi_overlay_drag_catch",
        "    move-exception v0",
        "    const/4 v0, 0x0",
        "    return v0",
        ".end method",
...
def _generate_overlay_service_smali(spec: dict[str, Any]) -> str:
    ...
    return "\n".join([
        ...
        "    .locals 1",
        "    :apkagi_overlay_start_try_start",
        "    invoke-static {p0}, Lapkagi/menu/InAppMenuBridge;->hasOverlayPermission(Landroid/content/Context;)Z",
        "    move-result v0",
        ...
        "    const/4 v0, 0x2",
        "    return v0",
        "    :apkagi_overlay_start_try_end",
        "    .catch Ljava/lang/Throwable; {:apkagi_overlay_start_try_start .. :apkagi_overlay_start_try_end} :apkagi_overlay_start_catch",
        ":apkagi_overlay_start_catch",
        "    const/4 v0, 0x2",
        "    return v0",
        ".end method",
        "",
        ...
        "    .locals 2",
        "    :apkagi_overlay_destroy_try_start",
        ...
        "    return-void",
        "    :apkagi_overlay_destroy_try_end",
        "    .catch Ljava/lang/Throwable; {:apkagi_overlay_destroy_try_start .. :apkagi_overlay_destroy_try_end} :apkagi_overlay_destroy_catch",
        ":apkagi_overlay_destroy_catch",
        "    invoke-super {p0}, Landroid/app/Service;->onDestroy()V",
        "    return-void",
        ".end method",
        "",
        ...
        "    .locals 3",
        "    :apkagi_overlay_update_try_start",
        "    iget-object v0, p0, Lapkagi/menu/OverlayMenuService;->overlayParams:Landroid/view/WindowManager$LayoutParams;",
        "    iget-object v1, p0, Lapkagi/menu/OverlayMenuService;->windowManager:Landroid/view/WindowManager;",
        ...
        "    return-void",
        "    :apkagi_overlay_update_try_end",
        "    .catch Ljava/lang/Throwable; {:apkagi_overlay_update_try_start .. :apkagi_overlay_update_try_end} :apkagi_overlay_update_catch",
        ":apkagi_overlay_update_catch",
        "    return-void",
        ".end method",
        "",
        ".method public snapOverlayToEdge()V",
        "    .locals 8",
        "    :apkagi_overlay_snap_try_start",
        "    iget-object v0, p0, Lapkagi/menu/OverlayMenuService;->overlayParams:Landroid/view/WindowManager$LayoutParams;",
        ...
        "    return-void",
        "    :apkagi_overlay_snap_try_end",
        "    .catch Ljava/lang/Throwable; {:apkagi_overlay_snap_try_start .. :apkagi_overlay_snap_try_end} :apkagi_overlay_snap_catch",
        ":apkagi_overlay_snap_catch",
        "    return-void",
        ".end method",
        "",
        ".method private ensureOverlayShown()V",
        "    .locals 8",
        "    :apkagi_overlay_ensure_try_start",
        "    iget-object v0, p0, Lapkagi/menu/OverlayMenuService;->overlayRoot:Landroid/view/View;",
        ...
        ":apkagi_overlay_done",
        "    return-void",
        "    :apkagi_overlay_ensure_try_end",
        "    .catch Ljava/lang/Throwable; {:apkagi_overlay_ensure_try_start .. :apkagi_overlay_ensure_try_end} :apkagi_overlay_ensure_catch",
        ":apkagi_overlay_ensure_catch",
        "    return-void",
        ".end method",
        "",
